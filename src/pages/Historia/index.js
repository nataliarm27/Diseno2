...
function Historia() {
    return(
        ...
        <Boton className="absolute flex z-10 top-36 right-8  justify-center font-body text-yellow-600 bg-yellow-400 border-2 border-white rounded-2xl p-2 brightness-125 hover:text-white hover:bg-yellow-600 transition duration-150 ease-in-out" type="submit" titulo="Siguiente" />
        </div>
        </div>
